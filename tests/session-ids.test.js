...
// (upstream packages/schema/src/identifier.ts).
const goodSes = 'ses_0123456789abcdefABCDEFGHIJKLMN'.slice(0, 4 + 12 + 14);
const goodMsg = 'msg_0123456789abcdefABCDEFGHIJKLMN'.slice(0, 4 + 12 + 14);
